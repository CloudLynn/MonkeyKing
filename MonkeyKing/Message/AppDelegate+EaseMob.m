    ...
    [[EaseSDKHelper shareHelper] hyphenateApplication:application
                    didFinishLaunchingWithOptions:launchOptions
                                     ...
                                     apnsCertName:apnsCertName
                                      otherConfig:@{@"httpsOnly":[NSNumber numberWithBool:isHttpsOnly], kSDKConfigEnableConsoleLogger:[NSNumber numberWithBool:NO],@"easeSandBox":[NSNumber numberWithBool:[self isSpecifyServer]]}];
...
- (void)loginStateChange:(NSNotification *)notification
{
    ...
    if (_mainController == nil) {
        ...
        navigationController = [[EMNavigationController alloc] initWithRootViewController:_mainController];
    }else{
        navigationController  = (EMNavigationController *)_mainController.navigationController;
    }
    // 环信UIdemo中有用到Parse，您的项目中不需要添加，可忽略此处
    [self initParse];
    
    [ChatDemoHelper shareHelper].mainVC = _mainController;
...
//    else{//登陆失败加载登陆页面控制器
//        if (_mainController) {
//            [_mainController.navigationController popToRootViewControllerAnimated:NO];
//        }
//        _mainController = nil;
